<div wire:init="loadPosts">
                        ...
                        <article>
                            ...
                            <div class="py-4 px-6">
                                <h1 class="text-lg font-semibold">
                                    <a href="{{ route('lugaresTuristicos.show', $lugarTuristico) }}">
                                        {{-- ruta de cada uno --}}
                                        {{ Str::limit($lugarTuristico->nombre, 25) }}
                                    </a>
                                </h1>
                                <p class="font-bold text-trueGray-700">Ciudad: {{ $lugarTuristico->ciudad->nombre }}
                                </p>
                            </div>
                        </article>
                    </li>
                    ...
                    <li class="bg-white rounded-lg shadow {{ $loop->last ? '' : 'mr-4' }}">
                        <article>
                            <figure>
                                ...
                                @else
                                    <img class="h-48 w-full object-cover object-center"
                                        src="{{ $transportePrivado->images->first()->url }}" alt="">
                                @endif
                            </figure>
                            <div class="py-4 px-6">
                                <h1 class="text-lg font-semibold">
                                ...
                                <p class="font-bold text-trueGray-700">Tipo:
                                    {{ $transportePrivado->tipoTransPrivado->nombre }}</p>
                            </div>
                        </article>
                    </li>
                @endforeach
    ...
    @else
        {{-- MUESTRA UNA CARGA SI ESTA VACIO --}}
