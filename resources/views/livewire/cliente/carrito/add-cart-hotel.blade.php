<div x-data> {{-- aplicamos funcionalidades de Alpine --}}
    ...
    <p class="text-xl text-gray-700">Tipo de habitacion:</p>

    <select wire:model="habitacion_id" class="form-control w-full">
        <option value="" selected disabled>Seleccionar el tipo de habitacion</option>
    ...
    <p class="text-gray-700 my-4">
        <span class="font-semibold text-lg">Habitaciones disponibles:</span>
        {{ $quantity }}
    </p>
