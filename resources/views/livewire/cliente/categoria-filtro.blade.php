<div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
        {{-- el filtro de ciudad --}}
        <aside>
            <h2 class="font-semibold text-center mb-2">Ciudades</h2>
            <ul class="divide-y divide-gray-200">
                @foreach ($ciudades as $ciudads)
                    <li class="py-2 text-sm">
                        <a class="cursor-pointer hover:text-blue-500 {{ $ciudad == $ciudads->nombre ? 'text-blue-600 font-semibold' : '' }} "
                                ...
                                <div class="flex-1 py-4 px-6 flex flex-col">
                                    <div class="flex justify-between">
                                        <div class= "px-2">
                                            ...
                                            <p class="font-bold text-trueGray-700">Ciudad:
