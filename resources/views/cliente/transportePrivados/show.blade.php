<x-app-layout>
    <div class="container py-8">
        <div class="grid grid-cols-2 gap-6">
            ...
            <div>
                <h1 class="text-4xl font-bold text-teal-900 mt-3">{{ $transportePrivado->tipoTransPrivado->nombre }}
                </h1>
                    ...
                    <div class="p-4 flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <div>
                                ...
                                <p>El servicio ofrece transporte privado, manteniendo limpieza, modelos nuevos, y con
                                    drivers amables, confiables y de buen trato.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                @livewire('cliente.carrito.add-transporte-privado',['transportePrivado' => $transportePrivado])
