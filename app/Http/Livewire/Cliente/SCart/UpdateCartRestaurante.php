...
class UpdateCartRestaurante extends Component
{
    ...
    public function mount(){
        ...
        $mesa_id =$item->options['mesa_id'];
        $this->qty= $item->qty; //traemos la cant que ya habiamos seleccionado

        $this->quantity=qty_available($item->id,$this->categoria_id, $mesa_id); //almacena cant disponible actualizada
    }
    ...
    {
        return view('livewire.cliente.s-cart.update-cart-restaurante');
    }
}
